...
static LE_GATT_ATTR_T gGapSvcDb[GAP_IDX_TOP] =
{
    ...
    [GAP_IDX_DEVICE_NAME_VAL]      = CHARACTERISTIC_UUID16(&gGapDeviceNameUuid, LE_GATT_PERMIT_READ | LE_GATT_PERMIT_AUTHOR_WRITE, sizeof(g_app_data.ble_adv_name), sizeof(g_app_data.ble_adv_name) - 1, g_app_data.ble_adv_name),
